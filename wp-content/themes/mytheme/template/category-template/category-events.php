    ...
    <div class="container category-posts-container">
        ...
        <ul class="post-category-item-wrap-gridview row">
            ...
            $args = array(
                ...
                'posts_per_page' => $postPer,  // Number of posts per page
                    ...
                    <li class="col-sm-5">
                        <a href="<?php the_permalink(); ?>" class="post-category-item" style="display: inline-grid;">
                            ...
                            <div class="text-post-category-item">
                                ...
                                <div class="poppins-regular post-excerpt " style="line-break:anywhere"><?php echo excerpt(60); // Display the excerpt ?></div>
                            </div>
                        </a>
                    </li>
                    <?php
